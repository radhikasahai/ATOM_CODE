...
def rf_models(train_x, train_y, test_x, test_y, rf_type, parameters,printout=False):
    ...
    if (rf_type == 'RF'): # bootstrap=False
        model = RandomForestClassifier(n_estimators=n_estimators, criterion=criterion, max_depth=max_depth, min_samples_split=min_samples_split
                                , min_samples_leaf=min_samples_leaf, bootstrap=False, max_features=max_features, class_weight=class_weight)
    elif (rf_type == 'RF_BCW'):  # bootstrap=False
        model = RandomForestClassifier(n_estimators=n_estimators, criterion=criterion, max_depth=max_depth, min_samples_split=min_samples_split
                                , min_samples_leaf=min_samples_leaf, bootstrap=False, max_features=max_features, class_weight='balanced')
    elif (rf_type == 'BRFC'): # bootstrap=False (was default at the time of running, but now current sklearn changed deault to True)
        model = BalancedRandomForestClassifier(n_estimators=n_estimators, criterion=criterion, max_depth=max_depth, min_samples_split=min_samples_split
                                , min_samples_leaf=min_samples_leaf, bootstrap=False, max_features=max_features, class_weight=class_weight)
    elif (rf_type == 'BRFC_BCW'): # (was default at the time of running, but now current sklearn changed deault to True)
        model = BalancedRandomForestClassifier(n_estimators=n_estimators, criterion=criterion, max_depth=max_depth, min_samples_split=min_samples_split
                                , min_samples_leaf=min_samples_leaf, bootstrap=False, max_features=max_features, class_weight='balanced')
